...
map <super>d oimport IPython; IPython.embed()
vnoremap < <gv
vnoremap > >gv
...
silent only
silent tabonly
cd ~/work/bc_learning_sound
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +16 keras_training.py
badd +117 dataset.py
badd +120 ~/work/tensorflow-ESC50/dataset.py
badd +39 ~/work/tensorflow-ESC50/keras_test.py
badd +3 models/convbnrelu.py
badd +1 models/envnet.py
badd +81 models/envnetv2.py
badd +1 train.sh
badd +1 train2.sh
...
wincmd w
argglobal
if bufexists('models/envnetv2.py') | buffer models/envnetv2.py | else | edit models/envnetv2.py | endif
let s:cpo_save=&cpo
set cpo&vim
noremap <buffer> <F7> :call flake8#Flake8()
let &cpo=s:cpo_save
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((0 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
wincmd w
argglobal
if bufexists('test.sh') | buffer test.sh | else | edit test.sh | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
